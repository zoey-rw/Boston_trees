...
modal_data_text <- "<p>Mean summer temperature and prevalence of chronic asthma (used to recommend low-allergen trees on the 'Step 2' tab) comes from the
<a href='https://data.census.gov/cedsci/'> 2010 U.S. Census Bureau data.</a></p>
<p> Census tract demographics, used to calculate Heat Vulnerability Index (HVI), come from 
